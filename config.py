...
BOT_TOKEN = getenv("BOT_TOKEN","5058254155:AAFiUYVP8W4qqWogysOf4QPo3NDWxHcPC4M")
BOT_NAME = getenv("BOT_NAME", "Livestreamer Bot")
...
ALIVE_NAME = getenv("ALIVE_NAME", "Janith sadanuwan")
BOT_USERNAME = getenv("BOT_USERNAME", "@Livestreamerbotjs")
